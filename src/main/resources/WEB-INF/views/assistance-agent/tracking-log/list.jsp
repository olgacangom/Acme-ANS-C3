...
<acme:list>
	<acme:list-column code="assistance-agent.tracking-log.list.label.updateMoment" path="updateMoment" width="25%"/>
	...
	<acme:list-column code="assistance-agent.tracking-log.list.label.indicator" path="indicator" width="25%"/>
