...
<%@taglib prefix="acme" uri="http://acme-framework.org/"%>
	...
	<acme:form>
		...
		<acme:input-textbox code="administrator.airline.list.label.iata-code" path="iataCode"/>
		...
		<acme:input-moment code="administrator.airline.list.label.foundationMoment" path="foundationMoment" readonly="true"/>
